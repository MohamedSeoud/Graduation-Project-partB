  ...
  return (
    <>
      <section className="relative z-10 overflow-hidden pt-36 pb-16 md:pb-20 lg:pt-[180px] lg:pb-28">
                    ...
                    >
                      <div className="relative">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className="box ltr:mr-4 rtl:ml-4 mt-1 flex h-5 w-5 items-center justify-center rounded border border-body-color border-opacity-20 dark:border-white dark:border-opacity-10">
        ...
        <div className="absolute ltr:left-0 rtl:right-0 top-0 z-[-1]">
          <svg
            width="1440"
            height="969"
